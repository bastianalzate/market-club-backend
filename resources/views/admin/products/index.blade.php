...
@section('content')
    <div class="flex items-center justify-between mb-6">
        <div>
            ...
            <p class="mt-1 text-xs text-gray-400">Última actualización: {{ now()->format('Y-m-d H:i:s') }}</p>
        </div>
        <div class="flex items-center space-x-3">
            <button onclick="window.location.reload()" 
                class="inline-flex items-center px-3 py-2 text-sm font-medium text-gray-700 bg-white border border-gray-300 rounded-lg shadow-sm hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
