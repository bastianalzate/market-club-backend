...
class BeerProductSeeder extends Seeder
{
        ...
        $beerProducts = [
            [
                ...
                'product_specific_data' => [
                    ...
                    'alcohol_content' => 4.5,
                    'beer_style' => $this->mapBeerStyle('lager'),
            ...
            [
                ...
                'product_specific_data' => [
                    ...
                    'packaging_type' => 'lata',
                    'alcohol_content' => 4.2,
                    'beer_style' => $this->mapBeerStyle('stout'),
                    'brewery' => 'Guinness',
                ],
            ],
            [
            ...
            [
                ...
                'product_specific_data' => [
                    ...
                    'packaging_type' => 'botella',
                    'alcohol_content' => 4.4,
                    'beer_style' => $this->mapBeerStyle('pilsner'),
    ...
    {
        return ProductType::normalizeBeerStyle($style) ?? 'lager_clasica_pilsner';
    }
}